function kdTree(points, metric, dimensions) {
  ...
  this.insert = function(point) {
    var insertPosition = innerSearch(root, null);
    ...
    var newNode = new Node(point, (insertPosition.dimension+1)%dimensions.length);
    var dimension = dimensions[insertPosition.dimension];
    if(point[dimension] < insertPosition[dimension]) {
    ...
    function innerSearch(node, parent) {
      ...
      if(node.right == null) return innerSearch(node.left, node);
      if(node.left == null) return innerSearch(node.right, node);
